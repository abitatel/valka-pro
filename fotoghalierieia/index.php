...
<div class="max s-bar">
    ...
    <div class="right-block">
        <div class="banner-page" style="background-image: url(/local/assets/img/pages/fotogalereya.png);">
            <h1 class="p-title"><span>Фотогалерея</span></h1>
        </div>
        ...
        <div class="text-page">
            <?php
                ...
                CMedialib::Init();
                $arItems = CMedialibItem::GetList(array('arCollections' => [1]));
            ?>

            <div class="foto-gal">
                <? foreach ($arItems as $arItem) : ?>
                    <div class="image">
                        <img src="<?= $arItem["PATH"]; ?>" alt="">
                    </div>
                <? endforeach; ?>
            </div>
        </div>
